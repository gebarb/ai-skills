...
See `~/.codeium/windsurf/docs/specs-references/specs-create/planning.md` for:
...
See `~/.codeium/windsurf/docs/specs-references/specs-create/execution.md` for:
...
- **Execution Phase**: `~/.codeium/windsurf/docs/specs-references/specs-create/execution.md` - Steps 6-13
