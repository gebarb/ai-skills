...
Run the installation script to copy all skills to your global Cascade/Windsurf directory:
...
1. Copy the workflow files to your Cascade/Windsurf workflows directory:
   ```bash
