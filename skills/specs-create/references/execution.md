...
- Planning Phase: `planning.md` (Steps 1-5)
...
- **Templates**: `templates.md` - Phase file and README templates
- **Maintenance**: `maintenance.md` - Migration, versioning, and import/export
- **Guidelines**: `guidelines.md` - Best practices and quality metrics
