...
- [Spec Update Handling](#spec-update-handling)
  - [When to Run Detection](#when-to-run-detection)
  - [When Spec Changes Are Detected](#when-spec-changes-are-detected)
  - [Update Impact Assessment](#update-impact-assessment)
  - [Handling Breaking Changes](#handling-breaking-changes)
  - [Handling Non-Breaking Changes](#handling-non-breaking-changes)
  - [Spec Version Locking](#spec-version-locking)
  - [Spec Version Locking Implementation](#spec-version-locking-implementation)
  - [Spec Version Mismatch Handling](#spec-version-mismatch-handling)
  - [Spec Version Locking Test Scenarios](#spec-version-locking-test-scenarios)
  - [Progress File Schema Update](#progress-file-schema-update)
  - [Spec Version Change Approval](#spec-version-change-approval)
...
- [Workflow Integration](#workflow-integration)
  ...
  - [Automated Implementation Considerations](#automated-implementation-considerations)
  - [Cross-Workflow References](#cross-workflow-references)
  - [Data Flow](#data-flow)
...
- [Skill Self-Testing and Validation](#skill-self-testing-and-validation)
